...
public class DeclmarchetitreKafkaResourceIT {
    ...
    @Autowired
    private DeclmarchetitreKafkaProducer producer;

    @Autowired
    private DeclmarchetitreKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclmarchetitreKafkaResource kafkaResource = new DeclmarchetitreKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declmarchetitre-kafka/publish?message=test"))
