package com.fisc.declmarchetitre.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("declmarchetitre");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("declmarchetitre");
        ...
        config.getMapConfigs().put("com.fisc.declmarchetitre.domain.*", initializeDomainMapConfig(jHipsterProperties));
